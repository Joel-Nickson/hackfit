          ...
          <div className="flex space-x-5">
            {navigation.map((item) => (
              <Link
                ...
                offset={40}
                duration={600}
                className="px-3 py-2 text-gray-300 hover:bg-gray-700 hover:text-white hover:-translate-y-0.5 active:bg-gray-800 active:translate-y-0.5 transform transition rounded-md text-sm font-medium font-Pixeboy"
              >
        ...
        <div className="md:hidden px-12 bg-gray-900 text-gray-100 flex flex-col items-center space-y-3">
          {navigation.map((item) => (
            <Link
              ...
              offset={50}
              duration={600}
              className="flex justify-center items-center bg-gray-800 w-full py-2 text-gray-300 active:bg-gray-500 active:translate-y-0.5 transform transition rounded-md text-sm font-medium font-Pixeboy tracking-wide"
            >
              {item.name.toUpperCase()}
            </Link>
          ))}
