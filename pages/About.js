...
const About = () => {
  return (
    <div
      id="about"
      className="flex flex-col sm:min-h-[90vh] min-h-[78vh] max-h-screen lg:flex-row-reverse items-center justify-around lg:justify-between bg-brochgreen text-gray-100"
    >
